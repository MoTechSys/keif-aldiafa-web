...
const C: IntentContent = {
  ...
  roles: [
    ...
    { kick: "التشكيل", h2: "تشكيل المباشرين والصبّابين يُحسب على ثلاثة أشياء", p: "لا نرسل «رقماً جاهزاً» — نحسب التشكيل من ثلاثة أشياء: عدد الضيوف، شكل المكان (قاعة واحدة أم أقسام؟ استراحة مفتوحة؟)، وطبيعة المناسبة. أرسل التفاصيل على واتساب ويصلك التشكيل المقترح كاملاً: العدد، الزيّ، والعدّة." },
  ],
  guideH2: ["دليل المباشر —", "إدارة القاعة الكبيرة"],
  guide: [

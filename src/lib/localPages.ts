...
export const CITIES: Record<string, LocalCity> = {
  jeddah: {
    ...
    // ترتيب مُقاس (D158): الأحياء التي يكتبها الباحث فعلاً مع «قهوجي» في GSC+Ads 2023→2026 أولاً
    // (الفيحاء 207 · المحمدية 164 · الزهراء 116 · المرجان 84 · البلد 48 · النسيم 15 · أبحر 12 · النعيم 7)، ثم بقية الأحياء الراقية.
    districts: ["الفيحاء", "المحمدية", "الزهراء", "المرجان", "أبحر الشمالية", "الشاطئ", "الحمراء", "الروضة", "الصفا", "النعيم", "الخالدية", "السلامة", "النسيم", "البساتين", "الحمدانية", "النهضة", "الأندلس", "البلد التاريخية"],

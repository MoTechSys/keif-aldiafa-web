    ...
    >
      ...
      <div className="relative max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-7 md:gap-10 mb-8 md:mb-12">
          ...
          <div className="md:col-span-2">
            ...
            <div className="flex gap-3 mt-5">
              <m.a href={waUrl} target="_blank" rel="noopener noreferrer" aria-label="واتساب" whileHover={{ scale: 1.1, y: -2 }} whileTap={{ scale: 0.95 }} className="w-10 h-10 rounded-full flex items-center justify-center min-h-[44px]" style={{ background: "#25D36612", border: "1px solid #25D36630", color: "#25D366" }}>
              ...
              <m.a href="https://www.instagram.com/keifaldiafa" target="_blank" rel="noopener noreferrer" aria-label="إنستغرام" whileHover={{ scale: 1.1, y: -2 }} whileTap={{ scale: 0.95 }} className="w-10 h-10 rounded-full flex items-center justify-center min-h-[44px]" style={{ background: "#E1306C12", border: "1px solid #E1306C30", color: "#E1306C" }}>
              ...
              <m.a href="https://www.tiktok.com/@keifaldiafa" target="_blank" rel="noopener noreferrer" aria-label="تيك توك" whileHover={{ scale: 1.1, y: -2 }} whileTap={{ scale: 0.95 }} className="w-10 h-10 rounded-full flex items-center justify-center min-h-[44px]" style={{ background: "rgba(0,0,0,0.3)", border: "1px solid rgba(255,255,255,0.15)", color: "#fff" }}>
              ...
              <m.a href="tel:+966508252134" aria-label="اتصل بنا" whileHover={{ scale: 1.1, y: -2 }} whileTap={{ scale: 0.95 }} className="w-10 h-10 rounded-full flex items-center justify-center min-h-[44px]" style={{ background: "rgba(184,134,11,0.1)", border: "1px solid rgba(184,134,11,0.3)", color: "#B8860B" }}>
            ...
            {/* رابط صفحة التواصل الكاملة — أيقونات الفوتر تحمل ٣ منصّات
                فقط، والصفحة تحمل الخمس مع الباركود. */}
            <Link
              href="/social"
              className="inline-flex items-center gap-1.5 mt-4 text-[0.8rem] text-[#B8860B] hover:text-[#D8A877] transition-colors"
            >
              <span>كل حساباتنا والباركود</span>
        ...
        >
          ...
          <div className="flex flex-row items-center justify-center gap-4 sm:gap-12 w-full flex-wrap overflow-x-auto pb-2">
          ...
          {/* البيانات النطامية — مطلوبة مع شعارات الجهات الرسمية
              (عرض الشعارات بلا رقم توثيق قد يُفهم كإيحاء باعتماد) */}
          <div className="mt-5 text-center">
            <p className="text-[#F5F5DC]/45 text-[11px] leading-relaxed">
              مؤسسة كيف الضيافة للأفراح والمناسبات
            </p>
            <p className="text-[#F5F5DC]/30 text-[11px] mt-1">
              الرقم الوطني الموحّد: <span dir="ltr" className="inline-block">7033069720</span>
            </p>
          </div>
        </m.div>

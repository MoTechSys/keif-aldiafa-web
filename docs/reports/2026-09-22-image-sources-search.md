...
| استثناء مقيس | أصل `hero/hero-desktop.webp` (3168×1344) و`hero/hero-mobile.webp` في keif-v2 يحملان **علامة بيضاوية واحدة** أصلاً (ليسا نظيفَين تماماً) — أي أن #99/#106 تُحلّان بنسخ أصل keif-v2 كما هو: شعار واحد، ودقّة أعلى من نسخة الموقع الحالية (1200×509) |
...
- `/tmp/three_sources.jpg` — الثلاثة جنباً إلى جنب (كتالوج ↔ keif-v2 ↔ images-watermarked/web) لـ#7 · #93 · #106 · #150 · #280 · #308 · #309 · #310.
- `/tmp/hero99.jpg` — #99: أصل keif-v2 (شعار بيضاوي واحد صغير أسفل) ↔ الكتالوج (شعاران كبيران متراكبان).

...
**ملاحظة استراتيجية**: `asoulaldiafa.com` (مشروع المالك الآخر — ⊘ حسب allpro HANDOFF سطر 22؛ رقم واتساب مختلف 966568997316؛ **يؤكده المالك**) يظهر #4–#5 في استعلامَي «ضيافة مناسبات جدة» و«كيف الضيافة جدة» بنفس slug `/diyafa-munasabat-jeddah` — **تنافس داخلي (cannibalization)** بين موقعَي المالك على نفس النية. قرار مالك: تمايز النية أو ربط الكيانين (sameAs/parentOrganization).
...
| 13 | asoulaldiafa = مشروع المالك | ⊘ يستند إلى allpro HANDOFF فقط؛ رقم واتساب مختلف — **يؤكده المالك** | grep HANDOFF:22 |

> 🚩 **ابدأ من `AGENTS.md` في جذر المستودع (2026-09-09)** — هو نقطة الدخول الوحيدة المُلزمة، وهذا الملف تاريخي بالكامل (يصف الموقع القديم قبل النموذج v6.9؛ المسارات والحزم فيه لم تعد موجودة).

# CLAUDE.md - دليل الوكلاء الذكي لمشروع كيف الضيافة

> ⚠️ **تحذير صلاحية (2026-09-02):** هذا الملف **تاريخي جزئياً** — كُتب قبل إعادة هيكلة المشروع ويحوي أسماء ملفات ومسارات لم تعد موجودة.
> **المصدر الملزم الوحيد** لسياسات المالك وحالة المشروع هو مستودع التوثيق `MoTechSys/allpro`:
> ابدأ من `allpro/BOOTSTRAP.md` ثم `02-context-memory/STATE.md` ثم آخر تقرير في `01-keif-aldiafa/reports/`.
> عند أي تعارض بين هذا الملف و allpro، يُعتمد allpro. مراجعة التعارضات: allpro تقرير 18 §3.5.
...
| **مستودع العمل** | https://github.com/MoTechSys/keif-aldiafa-web |
| **مستودع الإنتاج (Vercel)** | https://github.com/MoTechSys/keif-v2 — لا يُلمس إلا بأمر نشر صريح من المالك |
| **مستودع التوثيق** | https://github.com/MoTechSys/allpro |
| **الفرع الرئيسي** | main (دمج مباشر بعد بوابة الجودة — لا PR، نسخة احتياطية `old-version-YYYY-MM-DD` قبل أي دمج كبير) |

...
4. `docs/DECISIONS.md` كاملاً — **D109–D148** قرار مرقّم لكل شيء؛ القرار لا يُعدَّل بل يُنسَخ بقرار جديد يذكر ما ألغاه. **التالي الحر مكتوب في رأس الملف** — استعمله ولا تكرّر رقماً.
